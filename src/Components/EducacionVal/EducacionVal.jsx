    ...
    <div>
        ...
        <section className="certif-section-b">
            <p>Múltiples y variados diagnósticos develan que los esfuerzos de los sistemas educativos 
                ...
                educativos actuales. En otras palabras, <span class="certif-distinction">no existe mejor evaluación de la educación que la 
                cruda realidad social y no tenemos buenos resultados</span>. Altos índices de</p>
            <ul className="list-certif"> 
                <li><p>Violencia Escolar</p></li>
                <li><p>Embarazos Prematuros</p></li>
                <li><p>Adicciones</p></li>
                <li><p>Suicidios</p></li>
                <li><p>Deserción Escolar</p></li>
                <li><p>Bajo Rendimiento</p></li>
            </ul>
